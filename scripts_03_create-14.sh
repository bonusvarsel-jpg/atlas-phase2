...
cat > ~/atlas-phase2/scripts/14_phase42-self-optimizing-thresholds.js << 'EOF'
#!/usr/bin/env node
...
echo "✅ Part 1 created: ~/atlas-phase2/scripts/14_phase42-self-optimizing-thresholds.js"
