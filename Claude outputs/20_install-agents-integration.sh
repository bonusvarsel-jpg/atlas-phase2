...
# ATLAS Agent Integration Installation Script
# Installs Three Specialized Agents into your local ATLAS system

set -e

echo "🚀 Installing ATLAS Agent Integration..."

# Create scripts directory if it doesn't exist
mkdir -p ~/atlas-phase2/scripts

# Install Agent Library (No Express dependency)
cat > ~/atlas-phase2/scripts/17_atlas-agents-library.js << 'EOLIB'
// ATLAS Agent Integration Library
...
cat > ~/atlas-phase2/scripts/19_deploy-agents-to-railway.js << 'EOSRV'
...
echo ""
echo "🧪 To test agents locally:"
echo "   cd ~/atlas-phase2/scripts"
echo "   node -e \"const { ATLASMatrixOrchestrator } = require('./17_atlas-agents-library.js'); new ATLASMatrixOrchestrator().orchestrate().then(r => console.log('✅ Orchestration:', r.cycle_id));\""
echo ""
echo "🚀 To start Express server:"
echo "   cd ~/atlas-phase2/scripts"
